...
urlpatterns = [
    ...
    path('api/confusionmatrix/<int:id>/', confusion_matrix, name='confusion_matrix'),
    path('api/featureimportance/<int:id>/', feature_importance, name='feature_importance'),
    path('api/roc_curve/<int:id>/', roc_curve, name='roc_curve'),
    path('api/correlationmatrix/<int:id>/', correlation, name='correlation'),
